...
// ID duoc danh so tu tu tang dan
// Can phai ma hoa ID thanh mot chuoi bat ky nao do
// Tang tinh bao mat cho API
// Hieu suat giam xuong tang duoc tinh bao mat
...
func (uid UID) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf("\"s%s\"", uid.String())), nil
}
